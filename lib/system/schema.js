module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Bilekin\n\n\n'
      ...
      if (!('owners' in setting)) setting.owners = ['6285198947697']
      if (!('msg' in setting)) setting.msg = 'Hi +tag \n\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.style)) setting.style = 1
      if (!('cover' in setting)) setting.cover = 'https://i.ibb.co.com/X5vHf8T/2d-logo-design-E2-D7893.png'
      if (!('link' in setting)) setting.link = 'https://whatsapp.com/channel/0029Vao2rpAB4hdNYXR2WJ3l'
   } else {
      global.db.data.setting = {
         ...
         owners: ['6285198947697'],
         msg: 'Hi +tag \n\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 1,
         cover: 'https://i.ibb.co.com/X5vHf8T/2d-logo-design-E2-D7893.png',
         link: 'https://whatsapp.com/channel/0029Vao2rpAB4hdNYXR2WJ3l'
      }
   }
}
